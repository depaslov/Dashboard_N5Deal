...
const MONTHLY_REPORTS = [
  {
    ...
    subtitle:
      '36 статей (15 M&A / Deal Rooms + 21 licensing / fintech). Press Releases + Glossary + Deployment infra на дешборді. LB: 5 профілів, 7 crowd (акаунт забанили), WEB 2.0 у процесі, перша закупка PRNews.io.',
    period: 'Червень 2026',
