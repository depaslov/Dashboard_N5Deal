...
const MONTHLY_REPORTS: Array<{
...
}> = [
  {
    ...
    subtitle:
      '10 статей у блог + 8 WEB 2.0 + 8 Profiles. Задачі: конкурентний аналіз, повне налаштування GA4 + Clarity (наскрізна воронка), нові сторінки наповнення. Лінк-стрибок: DR 6→11, +201 беклінк, +179 реф. доменів. Уперше з’явилась органіка (65 візитів, 8 ключів). Перші AI-згадки (AI Mode 2, Perplexity 1).',
    period: 'Липень 2026',
