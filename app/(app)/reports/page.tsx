...
const MONTHLY_REPORTS: Array<{
...
}> = [
  {
    ...
    subtitle:
      '10 статей у блог + 8 WEB 2.0 + 8 Profiles. Лінк-стрибок: DR 6→11, +201 беклінк, +179 реф. доменів. Уперше з’явилась органіка (65 візитів, 8 ключів) — минулого місяця не було. Перші AI-згадки (AI Mode 2, Perplexity 1). GA4: 184 кліки.',
    period: 'Липень 2026',
