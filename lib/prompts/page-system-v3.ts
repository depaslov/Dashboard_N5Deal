...
## PART 10b — N5DEAL TERMINOLOGY & POSITIONING (hard rules — applies to every page, not just FAQ)

### Terminology — mandatory replacements (no exceptions)

Replace every occurrence in the page:
- "listings" → "assets"
...
- "startup" — cap at 1–2 occurrences per page; otherwise use "business", "company", or "venture"
